                            ...
                            this.state.clinics.map(
                                clinic =>
                                    <tr id="lista" key={clinic.idKlinike}>
                                        ...
                                        <td>{clinic.adresa}</td>
                                        <td>
                                            <button onClick={() => this.viewClinic(clinic.idKlinike)}
                                                    className="btn btn-info">Pregled
                                            </button>
                                            <button style={{marginLeft: "10px"}}
                                                    onClick={() => this.editClinic(clinic.idKlinike)}
                                                    className="btn btn-light">Izmeni
                                            </button>
                                            <button style={{marginLeft: "10px"}}
                                                    onClick={() => this.deleteClinic(clinic.idKlinike)}
                                                    className="btn btn-danger">Obrisi
                                            </button>
                                        </td>
                                    </tr>
                            )
