                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            ...
                            <ul className="navbar-nav">
                                <li className="nav-item"><Link className="nav-link" to="/registracija"><MDBIcon
                                    icon="user-plus"/>Registracija</Link></li>
                                <li className="nav-item"><Link className="nav-link" to="/pacijenti/prijava"><MDBIcon
                                    icon="sign-in-alt"/>Prijava</Link></li>
                            </ul>
                        </div>
                    </div>
                </nav>
