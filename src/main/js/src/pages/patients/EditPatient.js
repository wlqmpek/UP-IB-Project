...
const  EditPatientDetails = () => {
    ...
    const update = async () => {
        ...
        console.log("Did token expire " + TokenService.didTokenExpire());
        console.log("Role = role " + (AuthenticationService.getRole().localeCompare("ROLE_ADMINISTRATOR") ));
        if((!TokenService.didTokenExpire()) && (AuthenticationService.getRole() == "ROLE_ADMINISTRATOR" || AuthenticationService.getRole() == "ROLE_PACIJENT")){
